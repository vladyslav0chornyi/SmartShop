...
set_target_properties(TBB::tbb PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/openvino/libs/libtbb.so.12"
  IMPORTED_SONAME_RELEASE "libtbb.so.12"
  )

list(APPEND _IMPORT_CHECK_TARGETS TBB::tbb )
list(APPEND _IMPORT_CHECK_FILES_FOR_TBB::tbb "${_IMPORT_PREFIX}/openvino/libs/libtbb.so.12" )
...
set_target_properties(TBB::tbbmalloc PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/openvino/libs/libtbbmalloc.so.2"
  IMPORTED_SONAME_RELEASE "libtbbmalloc.so.2"
  )

list(APPEND _IMPORT_CHECK_TARGETS TBB::tbbmalloc )
list(APPEND _IMPORT_CHECK_FILES_FOR_TBB::tbbmalloc "${_IMPORT_PREFIX}/openvino/libs/libtbbmalloc.so.2" )
...
set_target_properties(TBB::tbbmalloc_proxy PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/openvino/libs/libtbbmalloc_proxy.so.2"
  IMPORTED_SONAME_RELEASE "libtbbmalloc_proxy.so.2"
  )

list(APPEND _IMPORT_CHECK_TARGETS TBB::tbbmalloc_proxy )
list(APPEND _IMPORT_CHECK_FILES_FOR_TBB::tbbmalloc_proxy "${_IMPORT_PREFIX}/openvino/libs/libtbbmalloc_proxy.so.2" )
...
set_target_properties(TBB::tbbbind_2_5 PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/openvino/libs/libtbbbind_2_5.so.3"
  IMPORTED_SONAME_RELEASE "libtbbbind_2_5.so.3"
  )

list(APPEND _IMPORT_CHECK_TARGETS TBB::tbbbind_2_5 )
list(APPEND _IMPORT_CHECK_FILES_FOR_TBB::tbbbind_2_5 "${_IMPORT_PREFIX}/openvino/libs/libtbbbind_2_5.so.3" )
